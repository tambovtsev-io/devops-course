...
async def fetch_and_store_images(
    ...
    try:
        ...
        await db.save_image_data(response)
        ...
        async with db.async_session() as session:
            ...
            from src.civitai_client.civitai_db import ImageDB, ImageStatsHistoryDB, GenerationParametersDB
            ...
            if stored_image:
                ...
                if stats:
                    logger.info(f"Found stats: likes={stats.like_count}, hearts={stats.heart_count}")
                ...
                if params:
                    logger.info(f"Found generation parameters: model={params.model}, steps={params.steps}")
            else:
